...
/**
 * Хук для API-запросов с автоматической передачей Telegram initData.
 *
 * Зачем отдельный хук вместо голого fetch:
 * - Не копируем заголовок X-Init-Data в каждом компоненте
 * - Централизованная обработка ошибок
 * - Легко заменить/расширить (например, добавить retry или кеш)
 *
 * Возвращает объект с методами get() и post() — обёртки над fetch.
 */
